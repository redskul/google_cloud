...
# Build Date:   Mon 18 Jan 2021 08:57:15 AM PST
# ------------------------------------------------------------------------
...
def GenerateConfig(context):
  ...
  sap_hana_sidadm_password = str(context.properties.get('sap_hana_sidadm_password', 'Google123'))
  sap_hana_system_password = str(context.properties.get('sap_hana_system_password', 'Google123'))
